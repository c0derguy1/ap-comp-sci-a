...

{
...

    {
        ...
        double g = 100*Math.random();
        System.out.println("\n" + raceToday((int)g,true));
        System.out.println(numValue((int)g));
    ...
    **/
    ...
    {               
        ...
        {
            System.out.println("Yes, you can race today.");
            return true;
        }
        else
        {
    ...
    /** Question 12: Define a function to determine if a number entered is even, then returns that number times 5. If
